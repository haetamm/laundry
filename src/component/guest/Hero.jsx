...
const Hero = () => {
    return (
        <>
            <div className="min-h-[50px] max-w-screen-xl mx-auto inline xs:flex justify-center pt-0  xs:pt-8 md:pt-6 lg:pt-10 px-6">
                <div className="lg:mt-0 w-full xs:w-1/2 lg:col-span-5 lg:flex order-2 justify-center lg:justify-end">
                    <img
                        src="/image/laundry-hero1.png"
                        className="flex justify-center mx-auto lg:mx-0 items-center h-[284px] w-[328px] xs:h-[265px] xs:w-[400px] md:h-[295px] md:w-[459px] tab:h-[360px] lg:h-[433px] lg:w-[500px]"
                        height="500"
                        width="500"
                        alt="default"
                    />
